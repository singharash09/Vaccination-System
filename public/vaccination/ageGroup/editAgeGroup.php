                       ...
                       ?>
                         <div class="col-sm-6">
                          ...
                          <div class="col-sm-3">
                              ...
                              <input type="number" value="<?php echo  $editMinAge?>" class="form-control" id="min_age" name="min_age" placeholder="1" required>
                          </div>

                          <div class="col-sm-3">
                              <label for="max_age" class="form-label">Maximum Age</label>
                              <input type="number" value="<?php echo  $editMaxAge?>" class="form-control" name="max_age" id="max_age"  placeholder="1" required>                        
                          </div>
